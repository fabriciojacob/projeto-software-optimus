...
@ManagedBean(name = "pesquisaUnidMedBean")
@ViewScoped
public class PesquisaUnidMedBean extends FacesUtil implements Serializable {


	private static final long serialVersionUID = 5527469039512067571L;

	public PesquisaUnidMedBean(){
	...
	public void selecionaAliquota(Setor setor){
 	...
 	public void abrirDialogo() {
		...
		RequestContext.getCurrentInstance().openDialog("/privado/pesquisasGerais/pesquisaUnidMed", opcoes, null);
	}
}
